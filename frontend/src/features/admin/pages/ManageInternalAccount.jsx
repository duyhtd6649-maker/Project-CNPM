...
const ManageInternalAccount = () => {
  ...
  return (
    <div className="manage-page-container">
      {/* BOX SIDEBAR CHÍNH (Drawer trượt từ Admin Dashboard) */}
      ...
      {/* --- SIDEBAR XANH LAM CỐ ĐỊNH BÊN TRÁI --- */}
      <aside className="manage-left-sidebar">
        ...
        <nav className="sub-nav-list">
          {/* Thêm class nav-internal-black để chỉnh màu riêng */}
          <div 
            className={`sub-nav-item nav-internal-black ${activeTab === 'internal' ? 'active' : ''}`}
