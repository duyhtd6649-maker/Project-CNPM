...
const OrganizationProfile = () => {
  ...
  const API_URL_UPDATE_COMPANY = 'http://127.0.0.1:8000/api/recruiter/company/update/'; 
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const companyData = userData.company || {}; // Giả sử recruiter có field 'company' chứa object
        ...
        setData({
          ...
          location: companyData.location || "Chưa cập nhật",
          ...
          logo: companyData.logo || ""          // URL ảnh từ server
        });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      formData.append('industry', data.sector); 
      formData.append('employee_count_range', data.employees);
      ...
      await axios.patch(API_URL_UPDATE_COMPANY, formData, {
        headers: {
      ...
      <div className="left-column">
        ...
        <div className="card company-card">
          ...
          <div className="cover-image">
            <img 
              src={data.cover || "https://via.placeholder.com/1000x200?text=No+Cover"} 
              alt="Cover" 
              onError={(e) => e.target.src = "https://via.placeholder.com/1000x200?text=Error"}
            />
            {isEditing && (
