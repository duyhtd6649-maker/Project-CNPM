...
class Applications(AuditableModel):
    id = models.CharField(db_column='Id', primary_key=True, max_length=255,default=uuid.uuid4,editable=False)  # Field name made lowercase.
    ...
    job_status = models.CharField(db_column='JobStatus', max_length=50, blank=True, null=True)  # Field name made lowercase.
    system_status = models.CharField(db_column='SystemStatus', max_length=50, blank=True, null=True)  # Field name made lowercase.
